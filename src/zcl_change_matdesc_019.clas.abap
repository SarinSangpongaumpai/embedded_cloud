CLASS zcl_change_matdesc_019 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_change_matdesc_019 IMPLEMENTATION.
...
*        WITH VALUE #( ( %key-Product = 'DUMMY_PRODUCT_019'
*                        %key-Language = 'E'
*                        ProductDescription = 'Dummy Product 019- Updated') )
*
*        REPORTED DATA(reported)
*        FAILED DATA(failed).
*
